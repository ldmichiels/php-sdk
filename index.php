    ...
    <body>
        ...
        <main class="container">
            ...
            <div class="row">
                ...
                <p>
                    Note that these examples work for MLA(Argentina) by default. If you'd like to try them in your own country, please, <a href="https://github.com/mercadolibre/php-sdk/blob/master/configApp.php#L16">update this line</a> in your project, with
...
"title" => "Item De Teste - Por Favor, Não Ofertar! --kc:off",
        ...
        "listing_type_id" => "bronze",
        "condition" => "new",
        "description" => "Item de Testeo. Mercado Libre's PHP SDK.",
        "video_id" => "RXWn6kftTHY",
        "warranty" => "12 month",
        "pictures" => array(
            array(
